...
public class AssetBundleLoadDemo:MonoBehaviour 
{
    ...
    private void Awake()
    {
        //说明1：原始路径（注意win路径都是“反斜杠”）
        //E:\RD_WorkSpace\RD_AssetBundle\ProjectAssetBundle\AssetBundleTools\Assets\StreamingAssets\Win\commonscenes
        //说明2：修改为Unity支持的“参数杠”
        //E:/RD_WorkSpace/RD_AssetBundle/ProjectAssetBundle/AssetBundleTools/Assets/StreamingAssets/Win/commonscenes
        //说明3：win 平台下，URL前需要增加 “file:///”前缀 
        //_ABURL_1 = " file:///E:/RD_WorkSpace/RD_AssetBundle/ProjectAssetBundle/AssetBundleTools/Assets/StreamingAssets/Win/commonscenes/prefabs_1.ab";
        
        //说明4：使用Unity API简化路径
        _ABURL_1 = "file://" + Application.streamingAssetsPath + "/" + "Win/commonscenes/prefabs_1.ab";
        _AssetName_1 = "Cylinder";

        _ABURL_2 = "file://" + Application.streamingAssetsPath + "/" + "Win/scenes_2/textures_1.ab";
        _AssetName_2 = "DarkFloor";
    }
